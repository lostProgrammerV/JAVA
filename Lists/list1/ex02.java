...
public class ex02 {
	 ...
	 * civil do seu “estado/país” e que posteriormente o usuário 
	...
	public static void main(String[] args) {
		...
		while(idadeAtual < 0){
			idadeAtual = Integer.parseInt(JOptionPane.showInputDialog("Sua idade não pode ser negativa, digite novamente"));
		}
